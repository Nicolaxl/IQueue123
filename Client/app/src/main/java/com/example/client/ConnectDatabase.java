...
public class ConnectDatabase extends Thread {
    ...
    public ConnectDatabase(String url, String method, String[] field, String[] data) {
        this.url = url;
        this.method = method;
    ...
    public void run() {
        try {
            ...
            String result_line;
            while ((result_line = bufferedReader.readLine()) != null) result.append(result_line);
